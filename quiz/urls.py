...
from quiz.views import NewQuizView, QuizView, NewCategoryView, AddQuestionView, UpdateQuestionView, \
    UpdateQuizView, StartQuizView, SubmitQuizView, QuizDeleteView, QuestionDeleteView, UserQuizHistoryView, \
    QuizHistoryView
...
urlpatterns = [
    ...
    path('<int:pk>/view_results', QuizHistoryView.as_view(), name='view_results'),
