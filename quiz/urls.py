...
from quiz.views import NewQuizView, QuizView, NewCategoryView, AddQuestionView, UpdateQuizView
...
urlpatterns = [
    ...
    path('<int:pk>/edit-quiz/',UpdateQuizView.as_view(), name='editare_quiz'),
]